...
# above are the imports we shall use 
...
class ConsoleColors:
    HEADER = "\033[95m"# used to create colors for the terminal
    OKBLUE = "\033[94m"
    OKGREEN = "\033[93m"
    FAIL = "\033[92m"
    WARNING = "\033[91m"
...
#creating the port input function
...
def getport():
    try: 
        ...
        p = int(input(ConsoleColors.BOLD + ConsoleColors.WARNING + "Port must be a natural number, set port to default" + ConsoleColors.OKGREEN + 
                      "80"))
        return 80
    #user input section:
